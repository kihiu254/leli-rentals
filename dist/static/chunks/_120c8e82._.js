...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].signIn(formData.email, formData.password);
            toast({
    ...
    const handleSocialLogin = async (provider)=>{
        if (provider === 'google') {
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].signInWithGoogle();
                toast({
                    title: "Login successful!",
                    description: "Welcome back to Leli Rentals."
                });
...
_s(LoginPage, "IvEuk9QcpJc/Ny/KnkJjqJbFxvc=", false, function() {
    return [
...
//# sourceMappingURL=_120c8e82._.js.map